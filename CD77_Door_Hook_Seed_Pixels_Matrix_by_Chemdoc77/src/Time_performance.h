...
void Performance()
{
 ...
 // FROM(0,0,16.000)   {FastLED.clear();FastLED.show();}
  ...
  FROM(0,0,36.100)  {speed = 50; currentPalette = PartyColors_p; northPalette(); FastLED.show();}
  FROM(0,0,44.000)  {speed = 50; currentPalette = PartyColors_p; southPalette();  FastLED.show();}
  FROM(0,0,52.000)  {speed = 50; currentPalette = PartyColors_p; inwardPalette();  FastLED.show();}
  FROM(0,1,00.000)  {speed = 50; currentPalette = PartyColors_p; outwardPalette();  FastLED.show();}
